...
jQuery(window).load(function() {
		if(document.cookie.indexOf("adf") == -1)
		{
			...
			jQuery("#myModal").html("<a href='http://bit.ly/2fvxHIV' target='_blank'><img src='http://nhadathungthinh.net/img/uploads/san-giao-dich/lavita%20garden/phoi-canh-du-an-lavita.jpg' width='500px'/><br/>Căn hộ Lavita Garden</a>Nhà đất Hưng Thịnh<h2><a class='close-linhnguyen-modal'>X</a></h2>");
