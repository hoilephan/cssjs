...
jQuery(window).load(function() {
		if(document.cookie.indexOf("adf") == -1)
		{
			...
			jQuery("#myModal").html("<a href='http://bit.ly/2gx31Vl' target='_blank'><img src='http://nhadathungthinh.net/img/uploads/san-giao-dich/Saigon%20mia/sai-gon-mia-2.jpg' width='500px'/><br/>Căn hộ Saigon Mia </a>Nhà đất Hưng Thịnh<h2><a class='close-linhnguyen-modal'>X</a></h2>");
