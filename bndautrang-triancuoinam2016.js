...
jQuery(window).load(function() {
		if(document.cookie.indexOf("adf") == -1)
		{
			...
			jQuery("#myModal").html("<a href='http://bit.ly/2fSKWBA' target='_blank'><img src='http://datnenthuongmai.com/img/uploads/tin-tuc/Thi%20truong%20BDS/tin%20tuc%201/le-tri-an-khach-hang-kim-oanh-nam-2016.jpg' width='500px'/><br/>Tri ân khách hàng cuối năm </a>Nhà đất Kim Oanh<h2><a class='close-linhnguyen-modal'>X</a></h2>");
