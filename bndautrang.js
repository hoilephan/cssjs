...
jQuery(window).load(function() {
		if(document.cookie.indexOf("adf") == -1)  // Muốn xuất hiện liều lần thì đặt 2 đấu // đầu cùng
		{
			...
			jQuery("#myModal").html("<a href='https://goo.gl/pYdQ2F' target='_blank'><img src='http://nhadathungthinh.net/img/uploads/san-giao-dich/lavita%20garden/phoi%20canh%20lavita.jpg' width='500px'/><br/>Căn hộ Lavita Garden</a>Nhà đất Hưng Thịnh<h2><a class='close-linhnguyen-modal'>X</a></h2>");
